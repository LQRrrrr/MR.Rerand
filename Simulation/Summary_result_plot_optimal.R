  ...
  for (tauX in tauX_list)
{
   ...
   #bias
    ...
    for (tauy in tauY_list)
    {
      ...
      tau=tauX*tauy
      #Please update to your own laptop directory
...
colnames(power_final)=c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","Two-step MR","tauy_list")
colnames(coverage_final)=c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","Two-step MR","tauy_list")
...
colnames(sd_final)=c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","Two-step MR","tauy_list")
...
colnames(abias_final)=c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","Two-step MR","tauy_list")
abias.plot =abias_final %>% gather(key = Method, value = Bias, -tauy_list)

coverage.plot[,"Method"] <- factor(   coverage.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","Two-step MR"))
power.plot[,"Method"] <- factor(   power.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","Two-step MR"))
abias.plot[,"Method"] <- factor(   abias.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","Two-step MR"))

sd.plot[,"Method"] <- factor(   sd.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","Two-step MR"))
#power.plot =power_final %>% gather(key = Method, value = Power, - theta_list_star)
#power.plot =power_final %>% gather(key = Method, value = Power, - theta_list_star)
p1<-ggplot(subset(power.plot, !Method %in% c("DMVMR","MAGIC-Plugin")), aes(x=tauy_list, y=Power, color=Method,group = Method)) + geom_line(aes(linetype = Method),linewidth=1.2) +
...
p2<-ggplot(subset(coverage.plot, !Method %in% c("DMVMR","MAGIC-Plugin")), aes(x=tauy_list, y=Coverage, color=Method,group = Method)) + geom_line(aes(linetype = Method),linewidth=1.2) +geom_point(aes(shape =Method), size = 2)+geom_hline(yintercept = 0.95) +   scale_y_continuous(breaks = c(0,0.25,0.5,0.75, 0.95),labels = scales::number_format(accuracy = 0.01),limits = c(0,1))+scale_shape_manual(values =c(1,2,3,4,5,6,7)) +  scale_linetype_manual(values = c("solid",'dashed',  'dotted',"dashed")) + theme_bw() +
  theme(axis.title = element_text(face="bold", size = rel(1.2)),
        axis.text = element_text( size = rel(1.2)),
        axis.title.y = element_text(margin = margin(t = 0, r = 10, b = 0, l = 0, unit='pt')),
        legend.position = "bottom",
...
# Manually specify legend colors and labels
p1 <- p1 +
  scale_color_manual(values = c("MAGIC" = "#624c7c","MAGIC-Plugin"="#A52A2A","DMVMR" = "#98F5FF", "MVMR-IVW" = "#1E90FF", "Two-step MR" = "#FFBE7A")) +scale_shape_manual(values =c("MAGIC" = 1, "MAGIC-Plugin"=2,"DMVMR" = 3, "MVMR-IVW" = 4, "Two-step MR" = 5))+  scale_linetype_manual(values = c("MAGIC" = "solid","MAGIC-Plugin"="twodash", "DMVMR" = 'dashed', "MVMR-IVW" = 'dotted', "Two-step MR" = "dotdash"))
p2 <- p2 +
  scale_color_manual(values = c("MAGIC" = "#624c7c", "MAGIC-Plugin"="#A52A2A","DMVMR" = "#98F5FF", "MVMR-IVW" = "#1E90FF", "Two-step MR" = "#FFBE7A")) +scale_shape_manual(values =c("MAGIC" = 1, "MAGIC-Plugin"=2,"DMVMR" = 3, "MVMR-IVW" = 4, "Two-step MR" = 5))+  scale_linetype_manual(values = c("MAGIC" = "solid", "MAGIC-Plugin"="twodash","DMVMR" = 'dashed', "MVMR-IVW" = 'dotted', "Two-step MR" = "dotdash"))
p3 <- p3 +
  scale_color_manual(values = c("MAGIC" = "#624c7c", "MAGIC-Plugin"="#A52A2A","DMVMR" = "#98F5FF", "MVMR-IVW" = "#1E90FF", "Two-step MR" = "#FFBE7A")) +scale_shape_manual(values =c("MAGIC" = 1, "MAGIC-Plugin"=2,"DMVMR" = 3, "MVMR-IVW" = 4, "Two-step MR" = 5))+  scale_linetype_manual(values = c("MAGIC" = "solid", "MAGIC-Plugin"="twodash","DMVMR" = 'dashed', "MVMR-IVW" = 'dotted', "Two-step MR" = "dotdash"))
...
colnames(power_final)=c("MAGIC","MAGIC-Plugin","MVMR-IVW","Two-step MR","tau_list")
colnames(coverage_final)=c("MAGIC","MAGIC-Plugin","MVMR-IVW","Two-step MR","tau_list")
#colnames(power_final)=c("Rerand","MVMR(No measurement error)","MVMR-IVW","theta_list_star")
#colnames(coverage_final)=c("Rerand","MVMR(No measurement error)","MVMR-IVW","theta_list_star")
...
colnames(abias_final)=c("MAGIC","MAGIC-Plugin","MVMR-IVW","Two-step MR","tau_list")
abias.plot =abias_final %>% gather(key = Method, value = Bias, -tau_list)
coverage.plot[,"Method"] <- factor(   coverage.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","MVMR-IVW","Two-step MR"))
power.plot[,"Method"] <- factor(   power.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","MVMR-IVW","Two-step MR"))
abias.plot[,"Method"] <- factor(   abias.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","MVMR-IVW","Two-step MR"))

sd_final=data.frame(cbind(tau_rerand_se_l,tau_Optimal_se_l,tau_difference_se_l,tau_2step_se_l,tau_list_star))
colnames(sd_final)=c("MAGIC","MAGIC-Plugin","MVMR-IVW","Two-step MR","tau_list")
sd.plot =sd_final %>% gather(key = Method, value = MCSD, -tau_list)
sd.plot[,"Method"] <- factor(   sd.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","MVMR-IVW","Two-step MR"))


p5<-ggplot(subset(power.plot, !Method %in% c("MVMR-IVW","MAGIC-Plugin")), aes(x=tau_list, y=Power, color=Method,group = Method)) + geom_line(aes(linetype = Method),linewidth=1.2) +
...
p6<-ggplot(subset(coverage.plot, !Method %in% c("MVMR-IVW","MAGIC-Plugin")), aes(x=tau_list, y=Coverage, color=Method,group = Method)) + geom_line(aes(linetype = Method),linewidth=1.2) +
...
for (tauy in tauY_list)
{
  for (tauX in tauX_list)
  {
    ...
    colnames(power_final)=c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","theta_list_star")
    colnames(coverage_final)=c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","theta_list_star")
    ...
    colnames(abias_final)=c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","theta_list_star")
    abias.plot =abias_final %>% gather(key = Method, value = Bias, -theta_list_star)

    power.plot =power_final %>% gather(key = Method, value = Power, - theta_list_star)
    coverage.plot[,"Method"] <- factor(   coverage.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW"))
    power.plot[,"Method"] <- factor(   power.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW"))
    abias.plot[,"Method"] <- factor(   abias.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW"))
    sd_final=data.frame(cbind(theta_rerand_se_l,theta_Optimal_se_l,theta_mvmr_correct_se_l,theta_mvmr_se_l,theta_list_star))
    colnames(sd_final)=c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW","theta_list_star")
    sd.plot =sd_final %>% gather(key = Method, value = MCSD, -theta_list_star)
    sd.plot[,"Method"] <- factor(   sd.plot[,"Method"] ,levels = c("MAGIC","MAGIC-Plugin","DMVMR","MVMR-IVW"))

    p9<-ggplot(subset(power.plot, !Method%in%c( "DMVMR","MAGIC-Plugin")), aes(x=theta_list_star, y=Power, color=Method,group = Method)) + geom_line(aes(linetype = Method),linewidth=1.2) +
      geom_point(aes(shape =Method), size = 2)+geom_hline(yintercept = 0.05) +   scale_y_continuous(breaks = c(0.05,0.25,0.5,0.75,1),labels = scales::number_format(accuracy = 0.01),limits = c(0, 1)) + scale_shape_manual(values =c(1,2,3,4,5,6,7)) +  scale_linetype_manual(values = c("solid",'dashed',  'dotted',"dashed")) + theme_bw() +
      theme(axis.title = element_text(face="bold", size = rel(1.2)),
            axis.text = element_text( size = rel(1.2)),
            axis.title.y = element_text(margin = margin(t = 0, r = 10, b = 0, l = 0, unit='pt')),
    ...
    p10<-ggplot(subset(coverage.plot, !Method%in%c( "DMVMR","MAGIC-Plugin")), aes(x=theta_list_star, y=Coverage, color=Method,group = Method)) + geom_line(aes(linetype = Method),linewidth=1.2) +
